...
public class JwtTokenUtil implements Serializable {
    ...
    private String doGenerateToken(Map<String, Object> claims, String subject) {
        ...
        return builder().setClaims(claims).setSubject(subject).setIssuedAt(createdDate)
                .setExpiration(expirationDate).signWith(HS512, secret).compact();
    }
    ...
    public String refreshToken(String token) {
        ...
        return builder().setClaims(claims).signWith(HS512, secret).compact();
    }
